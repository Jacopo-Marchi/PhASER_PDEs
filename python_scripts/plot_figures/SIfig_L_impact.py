...
dirstrings=['{inp}/t7_F8_mf_1_L_1','{inp}/t7_F8real_mf_1_N__2','{inp}/t7_F8real_mf_1_N_t_3','{inp}/t4_F8_mf_1_L_1','{inp}/t4_F8_mf_1_L_2','{inp}/t4_F8_mf_1_L_3']
titstrings=[r'T7, L=1',r'T7, L=2',r'T7, L=3',r'T4, L=1',r'T4, L=2',r'T4, L=3']
t_ints=[44,54,54, 48,54,54]
...
for idir, dirstr in enumerate(dirstrings):
    ...
    for it, t in enumerate(times):
        ...
        if int(t) == t_int:
            ...
            heatmap = axs_fig2[row,col].pcolormesh(xx, yy,   wavesum , cmap='gray_r', alpha=0.5) # faster than pcolor
        ...
        #
            ...
            circle1 = plt.Circle(((6000  -L/2.)/1000, (6000  -L/2.)/1000), 45, color='b', fill=False, clip_on=True, ls=':', lw=4)
            
            axs_fig2[row,col].add_patch(circle1)
...
out_file='{out}/SIfig_L_impact.png'.format(out=dir_fig)
