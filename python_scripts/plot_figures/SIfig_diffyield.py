...
fig2, axs_fig2 = plt.subplots(nrows=1, ncols=3, figsize=(12,4.2),layout='constrained')

    
labeled_axes = []
labeled_axes.append(axs_fig2[0])
labeled_axes.append(axs_fig2[1])
labeled_axes.append(axs_fig2[2])
...
dirstrings=['{inp}/t7_F9_mf_1_gr_fact_0d5_re_cyield','{inp}/t7_F9_mf_1_gr_fact_1_phi_2e-8_eta_5','{inp}/t7_F9_mf_1_gr_fact_4_rescyield']
...
for idir, dirstr in enumerate(dirstrings):
    ...
    for it, t in enumerate(times):
        ...
        if bactprec is None:
            ...
            # ~ B_front=B_tot[id_first_bacts,id_first_bacts_x:]
            # ~ B_front=B_tot[id_first_bacts,id_first_bacts_x:]
            ...
            if wavespeed>0 and int(t) == t_estspeed:
                speedest=wavespeed
        ...
        if int(t) == t_int:
            ...
            heatmap_int = axs_fig2[idir].pcolormesh(xx, yy, intensities, cmap='gray',vmin=0, vmax=255, shading='auto', linewidth=0,rasterized=True) # faster than pcolor
            ...
            heatmap = axs_fig2[idir].pcolormesh(xx, yy,   wavesum , cmap='gray_r', alpha=0.5) # faster than pcolor, , alpha=0.5
            ...
            axs_fig2[idir].annotate("front {:.1f} mm/hr".format(speedest), xy=(-90, 85), xycoords='data',xytext=(0, 5), textcoords='offset pixels', color='k', fontsize=16)             
...
fig2.text(0.12,0.95,r'lower yield', rotation='horizontal', fontsize=16)
fig2.text(0.44,0.95,r'inferred growth', rotation='horizontal', fontsize=16)
fig2.text(0.81,0.95,r'higher yield', rotation='horizontal', fontsize=16)
...
out_file='{out}/SIfig_diffyield_fixchi.png'.format(out=dir_fig)
