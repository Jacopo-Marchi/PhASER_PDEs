...
dirstrings=['{inp}/t7_F9_plasticvirus','{inp}/t4_F9_plasticvirus']
t_ints=[36,42]
titstrings=[r'Phage T7, nonlinear',r'Phage T4, nonlinear']


figallee, axs_allee = plt.subplots(nrows=2, ncols=2, figsize=(8,8),  layout='constrained')# , layout='constrained',
...
mpsetup.label_axes([labeled_axes[1]], labels='B', xy=(-0.12, 0.95), **labeldict)
mpsetup.label_axes([labeled_axes[2]], labels='C', xy=(-0.12, 0.95), **labeldict)
mpsetup.label_axes([labeled_axes[3]], labels='D', xy=(-0.12, 0.95), **labeldict)
out_file='{out}/SIfig_plasticvir_highK.png'.format(out=dir_fig)
#    print out_file
