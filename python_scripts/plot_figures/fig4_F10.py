...
dir_io='{inp}/t7_F10'.format(inp=dir_fig)  # directory with input files
...
for it, t in enumerate(times):
    if it == 0 or int(t) in t_int + t_ref + t_estspeed + t_estspeedm2:
...
dir_io='{inp}/t4_F10'.format(inp=dir_fig)  # directory with input files
