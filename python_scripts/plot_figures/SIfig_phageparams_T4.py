...
for i_eta, eta in enumerate(etas[::-1]):
    for i_phi, phi in enumerate(phis):
        ...
        dirstr='{inp}/t4_F9_mf_1_gr_fact_1_phi_{phi}_eta_{eta}'
        ...
        t_int=min([int(np.amax(times)),60])
        ...
        for it, t in enumerate(times):
            ...
            if int(t) == t_int:
                ...
                if row==2 and col==1: 
                    ax.annotate("T4 parameters", xy=(-90, 85), xycoords='data',xytext=(0, 5), textcoords='offset pixels', color='k', fontsize=20)
...
out_file='{out}/SIfig_phage_params_T4.png'.format(out=dir_fig)
