...
The [Microsoft Excel file](./growth_data/Scanner_OD.xlsx) contains the calibration data used throughout the analysis to transform OD to CFUs and _viceversa_.
