...
[The plots folder](./plots) contains the python scripts to produce the figures once synthetic data are generated. Each script name's indicates which figure it corresponds to. All scripts reqire specific relative folder placements to retrieve the correct synthetic data. The synthetic data plotted in the manuscript are too heavy to be uploaded to this repository, but all code and information necessary to re-generate the model outputs are provided here and in the manuscript's Supplementary Text.
